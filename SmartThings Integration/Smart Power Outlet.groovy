metadata {
	...
	definition (name: "SmartPower Outlet V1", namespace: "smartthings", author: "SmartThings", minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		capability "Actuator"
		capability "Switch"
		capability "Sensor"
		capability "Outlet"
...
// Commands to device
def on() {
	log.info "${zigbee.deviceNetworkId}"
    
    if (device.id == "bdb7385b-c734-483c-bbee-198804899304"){
